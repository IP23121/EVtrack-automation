...
async def verify_auth(
    ...
    if credentials:
        ...
        # Try Cognito JWT first if configured (simplified for now)
        ...
        if cognito_user_pool_id and cognito_client_id:
            ...
            logger.info("Cognito configured but auth module not available")
            pass
        ...
        function initializeUppyForFileInput(fileParam, container) {
            ...
            uppy.on('file-added', (file) => {
                ...
                file.data.arrayBuffer().then(buffer => {
                    ...
                    statusDiv.textContent = `✓ ${file.name} ready for upload`;
                }).catch(err => {
